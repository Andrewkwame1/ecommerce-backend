...
# Database - Default to SQLite, can override in settings modules
DATABASES = {
    'default': {
...
# Cache configuration - Default to LocMemCache, can override in settings modules
CACHES = {
    'default': {
...
CELERY_RESULT_BACKEND = env('CELERY_RESULT_BACKEND', default='cache+locmem://')
